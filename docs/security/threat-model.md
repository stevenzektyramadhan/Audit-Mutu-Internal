...
| A-04, A-05, A-08, A-11 | Pengguna login yang menebak ID | **TM-05 IDOR** pada URL tugas, jawaban, bukti, laporan, RTM, dan tindak lanjut. | High — baca/ubah objek milik unit atau assignment lain. | M1-04 memusatkan policy assignment/evidence, memakai query ID + owner, mengulang scope pada mutasi, menolak perubahan nilai final, dan menguji ownership negatif lintas Auditee/Auditor. Admin/LPMPI masih institution-wide karena membership organisasi belum dimodelkan; RTM belum ada. | Pertahankan gate M1-04; tambahkan entitas membership/target organisasi sebelum membatasi admin per unit, lalu terapkan policy pada semua list, mutation, download, export, RTM, dan tindak lanjut yang baru. | Gunakan dua user, dua unit, dua assignment, ID berurutan dan ID tidak ada; uji GET/POST/AJAX/download/export. Respons ditolak seragam dan tidak membocorkan metadata. |
