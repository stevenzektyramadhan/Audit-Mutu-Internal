...
class Spmi_audits_model extends CI_Model
{
    ...
    public function package_questions($package_id) { return $this->db->select('q.*, i.indicator_code, i.title AS indicator_title')->from('spmi_instrument_questions q')->join('spmi_indicators i', 'i.id = q.indicator_id')->where('q.package_id', (int) $package_id)->order_by('q.display_order', 'ASC')->get()->result(); }
