...
$route['lpmpi/akun-import'] = 'lpmpi/Akun_import/index';
$route['lpmpi/akun-import/template'] = 'lpmpi/Akun_import/template';
$route['lpmpi/akun-import/preview'] = 'lpmpi/Akun_import/preview';
$route['lpmpi/akun-import/confirm'] = 'lpmpi/Akun_import/confirm';
$route['lpmpi/akun-import/cancel'] = 'lpmpi/Akun_import/cancel';
...
$route['auditee/spmi/assignment/(:num)/confirm'] = 'spmi_auditee_workspace/confirm/$1';
...
$route['auditor/spmi/item/(:num)/save'] = 'spmi_auditor_workspace/save_item/$1';
...
$route['auditor/spmi/assessment-item/(:num)/evidence/upload'] = 'spmi_auditor_workspace/upload_auditor_evidence/$1';
$route['auditor/spmi/auditor-evidence/(:num)/delete'] = 'spmi_auditor_workspace/delete_auditor_evidence/$1';
$route['auditor/spmi/auditor-evidence/(:num)/download'] = 'spmi_auditor_workspace/download_auditor_evidence/$1';
