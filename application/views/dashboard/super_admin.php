...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <span class="navbar-text text-white mr-3">Super Admin</span>
...
<div class="container mt-4">
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <p class="card-text">Selamat datang, <?php echo html_escape($this->session->userdata('nama')); ?>. Gunakan menu untuk mengelola pengguna, standar, pertanyaan, dan tugas audit.</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="card border-primary h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text">Kelola akun Super Admin, Auditor, dan Auditee.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="card border-success h-100 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title">Standar Audit</h5>
                    <p class="card-text">Buat dan edit standar audit untuk tugas.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="card border-warning h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text">Buat tugas audit, pilih auditor, auditee, dan standar.</p>
                </div>
            </div>
        </div>
    </div>
