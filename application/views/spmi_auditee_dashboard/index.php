...
$icon = static function ($name) {
    $paths = [
        ...
        'file-edit' => '<path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/>',
    ...
    return '<svg class="adte-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' . ($paths[$name] ?? $paths['clipboard-list']) . '</svg>';
};
?>
    ...
    <div class="tw-mx-auto tw-max-w-7xl">
        ...
        <section aria-labelledby="kpi-title" class="tw-mb-8">
            ...
            <div class="tw-grid tw-grid-cols-2 lg:tw-grid-cols-3 tw-gap-4">
                ...
                <div class="tw-rounded-2xl tw-border tw-border-slate-200 tw-bg-white tw-p-5 tw-shadow-sm">
                    <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                        <span class="tw-text-xs tw-font-semibold tw-text-slate-500">Draft Pengajuan</span>
                    ...
                    <div class="tw-text-2xl sm:tw-text-3xl tw-font-bold tw-tracking-tight tw-text-slate-950">
                        <?php echo (int) $dashboard['submissions_draft']; ?>
                    </div>
                    <p class="tw-mt-1 tw-text-[11px] tw-text-slate-500 tw-m-0">Dalam proses pengisian instrumen</p>
                </div>

                <!-- 3. Pengajuan Terkirim -->
                <div class="tw-rounded-2xl tw-border tw-border-slate-200 tw-bg-white tw-p-5 tw-shadow-sm">
                    <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                    ...
                    <p class="tw-mt-1 tw-text-[11px] tw-text-slate-500 tw-m-0">Telah dikirimkan ke auditor</p>
                </div>
                ...
                <div class="tw-rounded-2xl tw-border tw-border-slate-200 tw-bg-white tw-p-5 tw-shadow-sm">
                    ...
                    <p class="tw-mt-1 tw-text-[11px] tw-text-slate-500 tw-m-0">Batas akhir pengisian dalam 7 hari</p>
                </div>

                <!-- 5. Terlambat -->
                <div class="tw-rounded-2xl tw-border tw-border-slate-200 tw-bg-white tw-p-5 tw-shadow-sm sm:tw-col-span-2 lg:tw-col-span-1">
                    <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
        ...
        <section class="tw-flex tw-flex-col sm:tw-flex-row sm:tw-items-center sm:tw-justify-between tw-gap-4 tw-rounded-2xl tw-border tw-border-blue-200 tw-bg-blue-50/70 tw-p-6">
            ...
            <a href="<?php echo site_url('auditee/spmi'); ?>" class="tw-button-primary tw-text-xs tw-whitespace-nowrap">
                <span>Buka Workspace SPMI</span>
