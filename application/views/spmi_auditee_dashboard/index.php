...
<div class="ami-section-head mt-0">
    <div>
        <h2 class="ami-section-title">Dashboard SPMI Auditee</h2>
        <p class="text-muted mb-0">Ringkasan penugasan SPMI yang menjadi tanggung jawab Anda.</p>
    </div>
</div>

<section class="ami-panel mb-4" aria-labelledby="auditee-notifications">
    <div class="ami-panel-body">
        <h3 id="auditee-notifications" class="ami-section-title">Notifikasi</h3>
        <?php if (!$dashboard['notifications']): ?>
            <div class="ami-empty py-3">Belum ada notifikasi submission SPMI.</div>
        <?php else: ?>
...
<div class="ami-stat-grid">
    <?php foreach (['assignments' => ['Penugasan', 'fa-clipboard-list', 'tone-blue'], 'submissions_draft' => ['Submission Draft', 'fa-save', 'tone-teal'], 'submissions_submitted' => ['Submission Terkirim', 'fa-paper-plane', 'tone-blue'], 'due_soon' => ['Jatuh Tempo 7 Hari', 'fa-calendar-alt', 'tone-amber'], 'overdue' => ['Terlambat', 'fa-exclamation-circle', 'tone-rose']] as $key => $card): ?>
