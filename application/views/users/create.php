    ...
    <section class="users-surface form-shell">
        <div class="users-surface-body">
            <div class="form-header">
                ...
                <h1 class="users-heading">Tambah Pengguna Baru</h1>
                <p class="form-subtitle">Buat akun untuk mengatur akses ke sistem Audit Mutu Internal.</p>
            </div>
            ...
            <?php echo form_open('users/store'); ?>
                <div class="form-section">
                    ...
                    <div class="users-form-grid">
                        <div class="form-field">
                            ...
                            <input type="text" class="users-control" id="nama" name="nama" value="<?php echo html_escape(set_value('nama')); ?>" required>
                        </div>
                        <div class="form-field">
                            <label for="email" class="users-label">Alamat Email</label>
                            <input type="email" class="users-control" id="email" name="email" value="<?php echo html_escape(set_value('email')); ?>" required>
                        </div>
                        <div class="form-field">
                            <label for="password" class="users-label">Password</label>
                            <div class="users-password">
                                <input type="password" class="users-control" id="password" name="password" required>
                    ...
                    <div class="users-form-grid">
                        ...
                        <div data-unit-fields class="form-field-group tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4">
                            <div>
                                ...
                                <input type="text" class="users-control" id="nama_unit" name="nama_unit" value="<?php echo html_escape(set_value('nama_unit')); ?>" placeholder="Contoh: Program Studi Informatika">
                            </div>
                            <div>
                                <label for="jenis_unit" class="users-label">Jenis Unit</label>
                                <select class="users-control" id="jenis_unit" name="jenis_unit">
                                    <option value="">Pilih jenis unit...</option>
                                    <option value="prodi" <?php echo set_select('jenis_unit', 'prodi'); ?>>Prodi</option>
                                    <option value="unit" <?php echo set_select('jenis_unit', 'unit'); ?>>Unit</option>
                                    <option value="lembaga" <?php echo set_select('jenis_unit', 'lembaga'); ?>>Lembaga</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="users-actions tw-mt-6 tw-flex tw-flex-col tw-justify-end tw-gap-2 sm:tw-flex-row">
                    ...
                    <button type="submit" class="users-button users-button-primary">Simpan Pengguna</button>
                </div>
            <?php echo form_close(); ?>
        </div>
    </section>
