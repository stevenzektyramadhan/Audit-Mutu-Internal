...
$submit_post_in_body_offset = strpos($submit_function_body, 'submit_request(opener, assignment_url + "/submit"');
...
$resubmit_offset = strpos($return_helper_body, 'auditee_assignment_url + "/resubmit"');
